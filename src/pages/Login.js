    ...
    <div className='w-full h-screen'>
            ...
            <div className='fixed w-full px-4 py-24 z-50'>
                <div className='max-w-[450px] h-[550px] bg-black/80 text-white mx-auto'>
                    ...
                    <h1 className='text-3xl ml-12 mb-6 font-bold'>Sign In</h1>
                    <form onSubmit={loginHandler} 
                        ...
                        <button 
                        className='bg-red-600 py-3 rounded font-bold mx-12 px-6 my-8 hover:bg-red-700'>Sign In</button>
                        <div className='flex justify-between mx-12 text-gray-500 text-sm items-center font-bold'>
                            <p><input className='mr-2' type="checkbox" />Remember me</p>
                            <p>Need help ?</p>
                        </div>
                        <p className='text-center my-8 font-bold '><span className='text-gray-500 mr-2 '>Not a member ? </span>
                        <Link to='/signup'><span className='hover:underline decoration-solid decoration-red-600 underline-offset-4 transition-all'>Sign Up</span></Link>
                        </p>
                    </form>
                </div>
            </div>
